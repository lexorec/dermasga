...
assets/img/og-image.jpg  1200×630 image for link previews (WhatsApp, Facebook, X…)
favicon.ico, assets/img/favicon-*, icon-*, apple-touch-icon.png, site.webmanifest  Icons
robots.txt           Search-engine rules (sitemap.xml is generated by jekyll-sitemap)
